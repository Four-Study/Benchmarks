...
# hyper-parameters
parser         = argparse.ArgumentParser(description='DenseNet CIFAR100 Training')
parser.add_argument('--lr', default=0.05, type=float, help='learning rate')
parser.add_argument('--batch_size', default=256, type=int, help='batch size')
parser.add_argument('--n_epoch', default=300, type=int, help='number of epochs')
parser.add_argument('--depth', default=121, type=int, choices=[121, 161, 169, 201], help='depth of net')
...
if args.depth == 121:
    Net  = models.densenet121(pretrained=False, num_classes=nclass)
elif args.depth == 161:
    Net  = models.densenet161(pretrained=False, num_classes=nclass)
elif args.depth == 169:
    Net  = models.densenet169(pretrained=False, num_classes=nclass)
elif args.depth == 201:
    Net  = models.densenet201(pretrained=False, num_classes=nclass)
